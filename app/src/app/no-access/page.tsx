...
export default async function NoAccessPage() {
  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-6 py-12">
      <div className="w-full max-w-sm rise-in rounded-card border border-line bg-card p-6 text-center">
        ...
        <form action={signOut} className="mt-5">
          <button
            type="submit"
            className="pressable flex min-h-11 w-full items-center justify-center rounded-xl border border-line px-4 text-sm font-medium text-ink"
          >
            {t("signOutTryAnother")}
          </button>
        </form>
